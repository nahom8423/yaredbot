...
async def readingd1(ctx: ApplicationContext):
...
async def readingd2(ctx: ApplicationContext):
    week_number = (datetime.now().isocalendar()[1] - 1) % 52 + 1
...
async def readingkahin(ctx: ApplicationContext):
    week_number = (datetime.now().isocalendar()[1] - 1) % 52 + 1
...
async def wengel(ctx: ApplicationContext):
    week_number = (datetime.now().isocalendar()[1] - 1) % 52 + 1
...
async def commandpage(ctx: ApplicationContext):
...
async def mahletzema_command(ctx: ApplicationContext):
