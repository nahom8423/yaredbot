...
async def readingd1(ctx):
    ...
    image_path = f"deacon1/week{week_number}_readingd1.png"
...
async def readingd2(ctx):
    ...
    image_path = f"deacon2/week{week_number}_readingd2.png"
    await ctx.send(file=discord.File(image_path))
...
async def readingkahin(ctx):
    ...
    image_path = f"kahin/week{week_number}_readingkahin.png"
    await ctx.send(file=discord.File(image_path))
...
async def wengel(ctx):
    week_number = (datetime.now().isocalendar()[1] - 1) % 52 + 1
    image_path = f"wengel/week{week_number}_wengel.png"
